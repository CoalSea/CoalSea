...
if st.button("Go to XYZ.com"):
    st.markdown("[Link to XYZ.com](https://www.xyz.com)")
    
    
st.title("Explore Famous Landmarks")
st.markdown("---")

st.sidebar.title("Landmarks")
selected_category = st.sidebar.selectbox("Select a category", list(landmark_data.keys()))

if selected_category == "Famous Ships":
    selected_landmark = st.sidebar.selectbox("Select a Famous Ship", list(landmark_data["Famous Ships"].keys()))
    ...
    selected_landmark = st.sidebar.selectbox("Select a Famous Fish", list(landmark_data["Famous Fish"].keys()))
